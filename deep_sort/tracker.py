...
class Tracker:
    ...
    def __init__(self, metric, max_iou_distance=1.0, max_age=8, n_init=2):
        self.metric = metric
    ...
    def _match(self, detections):
        ...
        def gated_metric(tracks, dets, track_indices, detection_indices):
            # gated_metric creates a cm based on appearance features
            # and caps it based on realism from KF
        ...
        return matches, unmatched_tracks, unmatched_detections, cm_app, cm_iou
